    ...
    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
      <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              ...
              <div class="mt-2">
                <div class="text-sm text-gray-500 h-60 overflow-scroll py-4">
                  ...
                  <br /><br />
                  I agree to utilize the services of Go To <?php echo do_shortcode('[company_name]'); ?> in an environment fit for learning. While the information contained in Go To <?php echo do_shortcode('[company_name]'); ?> course has been compiled from sources believed to be reliable and correct, the publisher makes no warranty, expressed or implied, with respect to the use of any information, method, or process disclosed in this publication nor that such use may not infringe upon privately owned rights, and does not assume any liabilities or responsibilities, expressed or implied, with respect to the use of, or for damages resulting from, the use of any information, method, or process disclosed in the publication or the accuracy of the information contained herein.
                  <br /><br />
                  ...
                  <br /><br />
                  I agree to pay the transaction total and have verified that Go To <?php echo do_shortcode('[company_name]'); ?> is a DMV Licensed Traffic School #E9633. Go To <?php echo do_shortcode('[company_name]'); ?> will electronically process my certificate to the DMV and Court Database free of charge.
                  <br /><br />
                  ...
                  <br /><br />
                  In the event I would like to pursue a refund I agree to notify Go To <?php echo do_shortcode('[company_name]'); ?> via email (help@trafficschoolassist.com) within 24 hours of payment. I agree that I will not pursue a refund through my credit card company, bank, or financial institution. Any refund provided may be subject to a nominal administration fee.
                  <br /><br />
                  I agree to pay any and all penalty fee(s) incurred by Go To <?php echo do_shortcode('[company_name]'); ?> within 15 days if I perform a chargeback for any reason with my credit card company, bank, or financial institution.
                  <br /><br />
                  I agree to notify Go To <?php echo do_shortcode('[company_name]'); ?> via email and afford 24 hours for corrections as needed if there is a technical issue. In the unlikely event Go To <?php echo do_shortcode('[company_name]'); ?> cannot make corrections I within 24 hours I will be refunded.
                  <br /><br />
                  I understand that Go To <?php echo do_shortcode('[company_name]'); ?> will quickly review my request and if it is determined that there was a technical problem resting solely upon Go To <?php echo do_shortcode('[company_name]'); ?> Web servers or Web-based applications, I will receive my refund. I understand that in the event Go To <?php echo do_shortcode('[company_name]'); ?> was not the fault of any errors, computers or operating systems, then I am not entitled to a refund.
                  <br /><br />
                  ...
                  I understand the information I provide before my final exam must be complete and accurate. In the event my certificate is not accepted by the court or dmv for any reason I will be charged a re-processing fee of $10.00 for Go To <?php echo do_shortcode('[company_name]'); ?> to resubmit my certificate of completion. There will be no exceptions.
                  <br /><br />
                  SYSTEM REQUIREMENTS
                  <br /><br />
                  I understand and agree that the Go To <?php echo do_shortcode('[company_name]'); ?> course is an e-learning, internet-dependent, interactive learning service that requires proper communication via the Internet. I understand that Go To <?php echo do_shortcode('[company_name]'); ?> makes every reasonable effort to ensure the proper operation of its technology and internet communication. However, Go To <?php echo do_shortcode('[company_name]'); ?> cannot guarantee the proper operation of my (user, student, registrant, etc.) computer, or the Internet.
                  <br /><br />
                  Go To <?php echo do_shortcode('[company_name]'); ?> SHALL NOT BE LIABLE for my (user, student, registrant, etc.) inability to complete the course due to technical problems including, but not limited to, technical problems with the internet, internet service provider(s), and/or my own computer or email software.
                  <br /><br />
                  I have read and understand Go To <?php echo do_shortcode('[company_name]'); ?>'s technical requirements and have determined that I can use this system. If I plan on taking Go To <?php echo do_shortcode('[company_name]'); ?>'s course using a Macintosh computer with an older version operating system than OSX, or if I am using a PC computer running Windows XP or older operating system, or if I am using the Linux OS, Firefox or AOL browser, or if I am behind a corporate firewall, I understand that Go To <?php echo do_shortcode('[company_name]'); ?>'s web-based application may not function properly and may not be supported. I understand that Go To <?php echo do_shortcode('[company_name]'); ?> will use EMAIL as a primary method of communicating important deadlines, receipts and tracking information about my traffic school course. I understand that I am responsible for ensuring that all Go To <?php echo do_shortcode('[company_name]'); ?> emails are not blocked by my email SPAM filters and that any and all emails that are returned to Go To <?php echo do_shortcode('[company_name]'); ?> due to misinformation or Spam filters will not be re-sent unless I make a special request to: Go To <?php echo do_shortcode('[company_name]'); ?> to do so.
                  <br /><br />
                  I agree to notify Go To <?php echo do_shortcode('[company_name]'); ?> during normal business hours in the event I fail the course and wait until further instruction is provided.
                  <br /><br />
                  Only 1 Low Price Guarantee may be applied per account and I must notify Go To <?php echo do_shortcode('[company_name]'); ?> via email prior to sign up to take advantage of the offer. No credit can be give AFTER payment has been made.
                  <br /><br />
        ...
        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
          <button type="button" class="inline-flex w-full justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm hover:bg-blue-500 sm:ml-3 sm:w-auto bg-primary text-white" id="terms-agree">Agree</button>
          ...
          <div class="mt-4 grid grid-cols-1 gap-y-3 sm:grid-cols-2 sm:gap-x-4">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-1 relative">
                ...
                <span class="view-password absolute right-4 top-4 text-gray-500 hover:text-gray-900 cursor-pointer transition-all duration-300">
