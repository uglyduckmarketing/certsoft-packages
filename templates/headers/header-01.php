<header class="border-b border-gray-200 bg-white">
  <div class="container mx-auto py-4 px-6">
    <div class="flex gap-1 md:gap-4 items-center justify-between">
      ...
      <div class="font-semibold text-xs md:text-sm text-gray-700">Returning Customer? <a href="<?php echo get_field('school_login_link'); ?>" class="text-blue-600">Login</a></div>
    </div>
  </div>
</header>